...
file <- "C:/Users/LLL29/Documents/R_script/DATA/Samusik_01_notransform.fcs"
...
data[,ncol(data)][is.na(data[,ncol(data)])] <- 0
...
write.table(res, file = "C:/Users/LLL29/Documents/R_script/RESULTS/cluster_labels_FlowSOM.txt", 
...
file_labels <- "C:/Users/LLL29/Documents/R_script/RESULTS/cluster_labels_FlowSOM.txt"
